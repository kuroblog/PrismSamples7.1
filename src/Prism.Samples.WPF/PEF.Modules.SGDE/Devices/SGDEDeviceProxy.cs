...
namespace PEF.Modules.SGDE.Devices
{
    using PEF.Common;
    ...
    /// 发衣柜硬件代理接口
    /// </summary>
    public interface ISGDEDeviceProxy
    {
        /// <summary>
        /// 连接
        /// </summary>
